...
export async function processReaction(event: ReactionEvent): Promise<void> {
  try {
    // TODO: Call API to record reputation event
    // The API will check if the emoji maps to a reputation trigger
...
export async function processKeyword(event: KeywordEvent): Promise<void> {
  ...
  try {
    // TODO: Call API to record keyword-based reputation event
