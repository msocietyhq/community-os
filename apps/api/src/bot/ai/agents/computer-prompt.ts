export const COMPUTER_TOOL_DESCRIPTION = [
  ...
  "Do not send GitHub org, repo, issue, or pull-request list lookups here — those are",
  "github's job, not gh on this machine. Use computer for git, file contents, CI,",
  "creating or reviewing PRs, and anything github cannot do.",
