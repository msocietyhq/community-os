...
export const DEFAULT_REPUTATION_TRIGGERS = [
  ...
  { type: "keyword" as const, value: "subhanallah", points: 1 },
  { type: "keyword" as const, value: "mashaallah", points: 1 },
  { type: "keyword" as const, value: "masyaallah", points: 1 },
  { type: "keyword" as const, value: "alhamdulillah", points: 1 },
  { type: "keyword" as const, value: "barakallah", points: 1 },
  { type: "keyword" as const, value: "👍", points: 1 },
  { type: "keyword" as const, value: "booo", points: -1 },
  { type: "keyword" as const, value: "ewww", points: -1 },
  { type: "keyword" as const, value: "👎", points: -1 },
] as const;
